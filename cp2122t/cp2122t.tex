...
Desta forma, determinamos que o gene do anamorfismo de $\ensuremath{\Varid{list2LTree}}$ deve ser:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  (cond auxCond evenBlock id) . p1 . half . cons}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{classicMerkleTree}\mathbin{::}\Conid{Hashable}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to {\FTree}\;\mathbb{Z}\;\mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{classicMerkleTree}\mathrel{=}\bot \mbox{\onelinecomment (hyloNEList conquer divide) . (map Main.hash)}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{substMatrix}\;\Varid{x}\;\Varid{linha}\mathrel{=}\cataNat{\alt{f_1 }{f_2 }}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}f_1 \mathrel{=}\underline{\lambda (\Varid{h}\mathbin{:}\Varid{t})\to \Varid{subst}\;\Varid{x}\;\Varid{linha}\;\Varid{h}\mathbin{:}\Varid{t}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
