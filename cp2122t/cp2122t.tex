...
\\[\blanklineskip]%
\>[B]{}\Varid{baseNEList}\;\Varid{f}\;\Varid{g}\mathrel{=}{}\<[19]%
\>[19]{}\Varid{id}+(\Varid{f}\times\Varid{g}){}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{\Conid{A}\mathbin{+}({\LTree}\;\Conid{A})}^2
          \ar[ll]_-{\ensuremath{\mathsf{in}\mathrel{=}\alt{\Conid{Leaf}}{\Conid{Fork}}}}
\\
     A^*
          \ar[u]^-{list2LTree}
          \ar[r]_-{\ensuremath{\Varid{outNEList}}}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times\Conid{A}}^*
          \ar[r]_-{\ensuremath{\Varid{g\char95 list2LTree}}}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}}^* \ensuremath{\times\Conid{A}}^*
          \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{list2LTree}}^2}
}
\end{eqnarray*}

Nós sabemos que $g\_list2LTree = id + \ensuremath{\conj{\Varid{f}}{\Varid{g}}}$. Então sobra determinar $f$ e $g$. Para tal vamos analisar
...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 list2LTree}\mathrel{=}(\Varid{id}+\conj{\Varid{cond}\;\Varid{auxCond}\;\Varid{getEvenBlock}\;\Varid{id}\comp \p1\comp \Varid{auxHalf}\comp \Varid{half}\comp \Varid{cons}}{\Varid{cond}\;\Varid{auxCond}\;\Varid{getEvenBlock}\;\Varid{id}\comp \p2\comp \Varid{auxHalf}\comp \Varid{half}\comp \Varid{cons}})\comp \Varid{outNEList}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{half}\mathbin{::}[\mskip1.5mu \Varid{a}\mskip1.5mu]\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{half}\;\Varid{list}\mathrel{=}\Varid{splitAt}\;(\length \;\Varid{list}\mathbin{\Varid{`div`}}\mathrm{2})\;\Varid{list}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxCond}\mathbin{::}[\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{auxCond}\;\Varid{l}\mathrel{=}\length \;\Varid{l}\mathbin{>}\mathrm{1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxHalf}\mathbin{::}([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu])\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{auxHalf}\;(l_1 ,l_2 )\mid \length \;l_1 \mathbin{<}\length \;l_2 \mathrel{=}(l_1 \mathbin{+\!\!\!+}[\mskip1.5mu \Varid{last}\;l_1 \mskip1.5mu],l_2 ){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \length \;l_2 \mathbin{<}\length \;l_1 \mathrel{=}(l_1 ,l_2 \mathbin{+\!\!\!+}[\mskip1.5mu \Varid{last}\;l_2 \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{otherwise}\mathrel{=}(l_1 ,l_2 ){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{g\char95 lTree2MTree}\mathrel{=}\alt{\Conid{Unit}\comp \conj{\Varid{\Conid{Main}.hash}}{\Varid{id}}}{\uncurry{\Conid{Comp}}\comp \conj{\Varid{concHash}\comp ((\Varid{firsts}\comp \mathsf{out})\times(\Varid{firsts}\comp \mathsf{out}))}{\Varid{id}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{pairsList}\mathbin{::}[\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{pairsList}\mathrel{=}\anaList{\Varid{g\char95 pairsList}}\comp \Varid{getEvenBlock}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g\char95 pairsList}\mathrel{=}(\Varid{id}+\conj{\Varid{auxPairList}}{(\Varid{drop}\;\mathrm{1})\comp \p2})\comp \Varid{outList}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxPairList}\mathbin{::}(\Varid{a},[\mskip1.5mu \Varid{a}\mskip1.5mu])\to (\Varid{a},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{auxPairList}\;(\Varid{a},[\mskip1.5mu \mskip1.5mu])\mathrel{=}(\Varid{a},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{auxPairList}\;(\Varid{a},\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\Varid{a},\Varid{h}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{classicMerkleTree}\mathbin{::}\Conid{Hashable}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to {\FTree}\;\mathbb{Z}\;\mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{classicMerkleTree}\mathrel{=}(\Varid{hyloNEList}\;\Varid{conquer}\;\Varid{divide})\comp (\map \;\Varid{\Conid{Main}.hash}){}\<[E]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{wc\char95 w\char95 final}\mathbin{::}[\mskip1.5mu \Conid{Char}\mskip1.5mu]\to \mathbb{Z}{}\<[E]%
\\
...
A partir do cálculo efetuado em cima concluímos que $\ensuremath{h_1 }$ é a função constante $\ensuremath{\Varid{zero}}$ e $\ensuremath{h_2 }$ é a função
$\ensuremath{\Varid{cond}\;(\Varid{auxWcW}\comp ((\neg \comp \Varid{sp})\times\p2))\;(\succ \comp \p1\comp \p2)\;(\p1\comp \p2)}$.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}h_1 \mathrel{=}\Varid{zero}{}\<[E]%
\\
\>[B]{}h_2 \mathrel{=}\Varid{cond}\;(\Varid{auxWcW}\comp ((\neg \comp \Varid{sp})\times\p2))\;(\succ \comp \p1\comp \p2)\;(\p1\comp \p2){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxWcW}\mathbin{::}(\Conid{Bool},\Conid{Bool})\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{auxWcW}\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{x}\mathrel{\wedge}\Varid{y}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Determinar k:
\begin{eqnarray}
...
%
\just\equiv{\ensuremath{\Varid{lookahead\char95 sep}\;(\Varid{x}\mathbin{:}\Varid{y})\mathrel{=}\Varid{sp}\;\Varid{x}}}
          \ensuremath{\begin{lcbr}\Conid{True}\mathrel{=}k_1 \;\Varid{x}\\\Varid{sp}\;\Varid{x}\mathrel{=}k_2 \;(\Varid{x},(\Varid{wc\char95 w}\;\Varid{y},\Varid{lookahead\char95 sep}\;\Varid{y}))\end{lcbr}}
%
\just\equiv{Propriedade simétrica da igualdade}
        \ensuremath{\begin{lcbr}k_1 \;\Varid{x}\mathrel{=}\Conid{True}\\k_2 \;(\Varid{x},(\Varid{wc\char95 w}\;\Varid{y},\Varid{lookahead\char95 sep}\;\Varid{y}))\mathrel{=}\Varid{sp}\;\Varid{x}\end{lcbr}}
\qed
\end{eqnarray}

A partir do cálculo efetuado em cima concluímos que $\ensuremath{k_1 }$ é a função constante $\ensuremath{\underline{\Conid{True}}}$ e $\ensuremath{k_2 }$ tem que ser
a função $\ensuremath{\Varid{sp}\comp \p1}$.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\[\blanklineskip]%
\>[B]{}\Varid{recX}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{id}\times(\Varid{f}\times\Varid{f})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataX}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recX}\;(\Varid{cataX}\;\Varid{g})\comp \Varid{outX}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outUnit}\;(\Conid{Image}\;\Varid{a})\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outUnit}\;(\Conid{Text}\;\Varid{b})\mathrel{=}i_2\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times\Conid{A})\times(\Conid{A}\times\Conid{A})}^*
          \ar[ll]_-{\ensuremath{\Varid{inList}\mathrel{=}\alt{\Conid{Nil}}{\Conid{Cons}}}}
\\
     A^*
          \ar[u]^-{pairL}
...
\\
\>[B]{}\Varid{pairL}\mathrel{=}\Varid{pairLAux}\comp \anaList{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}(\Varid{id}+\conj{\Varid{auxPairL}}{\p2})\comp \Varid{outList}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pairLAux}\mathbin{::}[\mskip1.5mu (\Varid{a},\Varid{a})\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{pairLAux}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{pairLAux}\;\Varid{l}\mathrel{=}\Varid{init}\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxPairL}\mathbin{::}(\Varid{a},[\mskip1.5mu \Varid{a}\mskip1.5mu])\to (\Varid{a},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{auxPairL}\;(\Varid{a},[\mskip1.5mu \mskip1.5mu])\mathrel{=}(\Varid{a},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{auxPairL}\;(\Varid{a},\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\Varid{a},\Varid{h}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
duas funções presentes num $tuple$. A função auxiliar $\ensuremath{\Varid{compX}}$ trata disso e assim obtemos uma função $\ensuremath{f_2 }$ como
a seguinte $\ensuremath{\Varid{compX}\comp (\Varid{auxMarkMap}\comp \conj{\Varid{auxToCell}}{\p1}\times\Varid{id})}$.
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}f_2 \mathrel{=}\Varid{compX}\comp (\Varid{auxMarkMap}\comp \conj{\Varid{auxToCell}}{\p1}\times\Varid{id}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compX}\;(\Varid{f},\Varid{g})\mathrel{=}\Varid{f}\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxMarkMap}\mathrel{=}\uncurry{\uncurry{\Varid{substMatrix}}}\comp \Varid{assocl}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxToCell}\mathrel{=}\uncurry{\Varid{toCell}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{substMatrix}\mathbin{::}\Varid{a}\to \Conid{Int}\to \Conid{Int}\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{substMatrix}\;\Varid{x}\;\Varid{coluna}\mathrel{=}\cataNat{\alt{f_1 }{f_2 }}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}f_1 \mathrel{=}\underline{\lambda (\Varid{h}\mathbin{:}\Varid{t})\to \Varid{subst}\;\Varid{x}\;\Varid{coluna}\;\Varid{h}\mathbin{:}\Varid{t}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}f_2 \;\Varid{f}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\Varid{h}\mathbin{:}\Varid{f}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
