...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 list2LTree}\mathrel{=}(\Varid{id}+\conj{\Varid{cons}\comp (\Varid{id}\times(\p1\comp \Varid{half}))}{\p2\comp \Varid{half}\comp \p2})\comp \Varid{outNEList}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}h_2 \mathrel{=}\Varid{cond}\;(\Varid{auxWcW}\comp \conj{\neg \comp \Varid{sp}\comp \p1}{\p2\comp \p2})\;(\succ \comp \p1\comp \p2)\;(\p1\comp \p2){}\<[E]%
\\[\blanklineskip]%
